#define COMPONENT KJW_NoHolsterHolster
#define COMPONENT_GENERAL KJW_NoHolsterHolster
#define COMPONENT_SHORT KJW_NHH
#define COMPONENT_BEAUTIFIED KJW's No Holster Holster
